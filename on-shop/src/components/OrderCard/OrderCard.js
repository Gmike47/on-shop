    ...
    return (
        <div className='order-card-container'>
            <div className='order-card-header'>
                ...
                <div>
                    <p className='order-card-header-title bottom'><Moment format='LL'>{created}</Moment></p>
                    <p className='order-card-header-title bottom'>{`$${total/100}`}</p>
                    <p className='order-card-header-title bottom'>example email</p>
                    <div className='order-card-action-container'>
                        <p className='order-card-header-title bottom'>Order Details</p>
                        <Divider orientaion='vertical' variant='middle'/>
